...
document.getElementById("downloadCV").addEventListener("click", function() {
    const cvUrl = "Baishali_Resume_250224_005648.pdf";  // Ensure the file is inside your project folder

    const link = document.createElement("a");
    link.href = cvUrl;
    link.download = "Baishali_Resume.pdf";  // The file name for download
